...
import { HttpService, LocalStorageService, type IStorageService, type QueryObject, UrlQueryService, type IHttpService, type IUrlQueryService } from "@/shared";
...
export default {
    install(app: App) {
        ...
        app.provide<IStorageService>(DependencyInjectionKeys.localStorageService, localStorageService);
    }
};